package wander 
{
	...
	{
		public var background:ZlxObject;
		public var parent:ZlxObject;
		public var parentOffsets:FlxPoint;
		public var text3D:Text3D;
		
		public function TextBubble(X:Number, Y:Number, Z:Number, txt:String, parent:ZlxObject, parentObjectLayer:FlxGroup, parentTextLayer:FlxGroup)
		{
			super();
			parent = par;
			parentOffsets = new FlxPoint(X - parent.x, Y - parent.y, Z - parent.z);
			background = new ZlxObject(X, Y, Z);
